...
Letters.prototype = {
    init: function(options){
        ...
        this.easing = options && options.hasOwnProperty('easing') ? options.easing : d3.easeCubicInOut;
    ...
    initAlphabet: function(weight, rounded){
        ...
        this.alphabet = {
            ...
            'ą': {
                ...
                final: [{begin: '50%', end: '125% + 1'}, {begin: '50%', end: p50plusRW}, {begin: '28.5%', end: '125% + 1'}]
            },
            'b': {
                svg: svgSmall,
            ...
            'ł': {
                ...
                final: [{begin: p50minusRW12  , end: p50plusRW}, {begin: '0%', end: '75%'}]
            },
            'm': {
                svg: svgLarge,
            ...
            'ń': {
                ...
                final: [{begin: '-25%', end: '50%'}, {begin: p50minusRW, end: p50plusRW}, {begin: '0%', end: '75%'}]
            },
            'o': {
                svg: svgSmall,
                paths: [circleCenter],
            ...
            'w': {
                svg: svgLarge,
                paths: [lineLeftLarge, circleLeft, circleRight, lineRightLarge],
                initial: [{begin: '10%', end: '10%'}, {begin: '10%', end: '10%'}, {begin: '10%', end: '10%'}, {begin: '20%', end: '20%'}],
                final: [{begin: p50minusRW, end: '50%'}, {begin: '25%', end: '75%'}, {begin: '25% - 1', end: '90%'}, {begin: p50minusRW, end: '50%'}]
            },
            'w2': {
                svg: svgLarge,
